...
| SDD-015 | Model upgrades as Level-2 decisions w/ regression-test branch + A/B + cost analysis | P1 | H | H | H | S | -- | PI-5 Sprint 4 | **DONE** 2026-06-08 F-14: model-upgrade protocol, stdlib no-network A/B harness, pricing/workload fixtures, ADR-016 accepted, `decision-policy.md` cross-reference landed, and validation 12/12 REQUIRED checked. |
