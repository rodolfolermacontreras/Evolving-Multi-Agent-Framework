...
.github/
  ...
  skills/                            (28 skill files across 5 categories)
    AI-AGENT-SUPER-SKILL.md
    core/                            (sdd-constitution, project-context, git-workflow, testing-conventions)
    workflow/                        (archetype-recommender, triage, grill-me, grill-with-docs, to-spec, to-plan, to-tasks, implement)
...
- 28 composable skills across 5 categories
